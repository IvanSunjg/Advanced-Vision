...
#loads the unzipped train
dataset = ImageFolder('/home/s1557075/AVcw/train')
...
#load checkpoint
FILE = "/home/s1557075/resnet50_fconv_model_best.pth.tar"
...
optimizer = optim.SGD(model.parameters(), lr=0.006, weight_decay=0.01)
